...
{
    public class MensagensMovimentacao
    {
        public static string TIPO_MOV_INVALIDO => "Tipo de movimentação inválido!";
        public static string VALOR_NULO => "Valor não pode ser nulo!";
        public static string TIPO_NULO => "Tipo não pode ser nulo!";
        ...
        public static string VALOR_DEVE_SER_MAIOR_QUE_ZERO => "Valor não pode ser menor ou igual a zero.";
        ...
        public const string TITULO_TAMANHO_INVALIDO = "O título deve possuir entre 2 e 50 caracteres.";
    }
}
